...
int main() {
    ...
    int xc = 200, yc = 200;  // pivot
    int x = 250, y = 200;    // point to transform
    float angle = 45 * 3.14159265 / 180.0; // rotation in rad
    float sx = 2, sy = 1.5;  // scaling factors
    ...
    multiplyMatrix(R, T1, temp1);
    multiplyMatrix(S, temp1, temp2);
    multiplyMatrix(T2, temp2, M);
